...
@pytest.mark.parametrize("s", ["foo", "Foo", "FOO", "v$name",])  # issue291
...
@pytest.mark.parametrize(
    "s", ("LIKE", "ILIKE", "NOT LIKE", "NOT ILIKE", "NOT   LIKE", "NOT    ILIKE",)
)
...
@pytest.mark.parametrize(
    "s", ("LIKEaaa", "bILIKE", "aaILIKEbb", "NOTLIKE", "NOTILIKE",)
)
...
@pytest.mark.parametrize("s", ("AT TIME ZONE 'UTC'",))
